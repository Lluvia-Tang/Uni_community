...
public class ElasticsearchTests {
    ...
    @Test
    public void testInsertList(){ //批量添加
    ...
    public void testUpdate(){
        ...
        discussPostRepository.save(post); //覆盖修改
    }

    @Test
    public void testDelete(){
        discussPostRepository.deleteById(231);
//        discussPostRepository.deleteAll(); //删除全部，一般不使用比较危险
    }

    @Test
    public void testSearchByRepository(){
        //构造查询条件
        // 可以实现高亮显示搜索关键词 ==> 在关键词前后加标签<em>
        SearchQuery searchQuery = new NativeSearchQueryBuilder()
                .withQuery(QueryBuilders.multiMatchQuery("互联网寒冬", "title", "content")) //多查询条件
        ...
        //分页查询
        // elasticTemplate.queryForPage(searuchQuery, class, SearchResultMapper)
        // 底层获取到了高亮显示的值，但是没有返回
